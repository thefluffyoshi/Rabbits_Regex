...
class Rabbit_RegExTest
{
    ...
    @Test //TEST FIFTY-ONE
    void testUppercaseFrenchAngoraBreedName()
    {
        Rabbit_RegEx rabbit_breed = new Rabbit_RegEx();
        rabbit_breed.setBreedName("French Angora");
        String expected = "French Angora";
        assertEquals(expected, rabbit_breed.getBreedName());
    }//end uppercase breed name french angora

    @Test //TEST FIFTY-TWO
    void testLowercaseFrenchAngoraBreedName()
    {
        Rabbit_RegEx rabbit_breed = new Rabbit_RegEx();
        rabbit_breed.setBreedName("french angora");
        String expected = "french angora";
    ...
    void testLowercaseFrenchLopBreedName()
    {
        Rabbit_RegEx rabbit_breed = new Rabbit_RegEx();
        rabbit_breed.setBreedName("french lop");
        String expected = "french lop";
        assertEquals(expected, rabbit_breed.getBreedName());
    }//end lowercase breed name french lop

    @Test //TEST FIFTY-FIVE
    void testUppercaseGiantAngoraBreedName()
    {
        Rabbit_RegEx rabbit_breed = new Rabbit_RegEx();
        rabbit_breed.setBreedName("Giant Angora");
        String expected = "Giant Angora";
        assertEquals(expected, rabbit_breed.getBreedName());
    }//end uppercase breed name giant angora

    @Test //TEST FIFTY-SIX
    void testLowercaseGiantAngoraBreedName()
    {
        Rabbit_RegEx rabbit_breed = new Rabbit_RegEx();
        rabbit_breed.setBreedName("giant angora");
        String expected = "giant angora";
    ...
    void testLowercaseGiantChinchillaBreedName()
    {
        Rabbit_RegEx rabbit_breed = new Rabbit_RegEx();
        rabbit_breed.setBreedName("giant chinchilla");
        String expected = "giant chinchilla";
        assertEquals(expected, rabbit_breed.getBreedName());
    }//end lowercase breed name giant chinchilla
    ...
    @Test //TEST SEVENTY-ONE
    void testUppercaseSablePointColor()
    {
        Rabbit_RegEx rabbit_color = new Rabbit_RegEx();
    ...
    @Test //TEST SEVENTY-THREE
    void testUppercaseSandyColor()
    {
        Rabbit_RegEx rabbit_color = new Rabbit_RegEx();
        rabbit_color.setColor("Sandy");
        String expected = "Is the rabbit a baby?: false\n" +
                "How old is the rabbit?: 0 years\n" +
                "Weight: 0.0 in pounds\n" +
                "Color: Sandy\n" +
                "Gender: male";
        assertEquals(expected, rabbit_color.toString());
    }//end uppercase color sandy

    @Test //TEST SEVENTY-FOUR
    void testLowercaseSandyColor()
    {
        Rabbit_RegEx rabbit_color = new Rabbit_RegEx();
        rabbit_color.setColor("sandy");
        String expected = "Is the rabbit a baby?: false\n" +
                ...
                "Gender: male";
        assertEquals(expected, rabbit_color.toString());
    }//end lowercase color sandy

    @Test //TEST SEVENTY-FIVE
    void testUppercaseSealColor()
    {
        Rabbit_RegEx rabbit_color = new Rabbit_RegEx();
        rabbit_color.setColor("Seal");
        String expected = "Is the rabbit a baby?: false\n" +
                "How old is the rabbit?: 0 years\n" +
                "Weight: 0.0 in pounds\n" +
                "Color: Seal\n" +
                "Gender: male";
        assertEquals(expected, rabbit_color.toString());
    }//end uppercase color seal

    @Test //TEST SEVENTY-SIX
    void testLowercaseSealColor()
    {
        Rabbit_RegEx rabbit_color = new Rabbit_RegEx();
        rabbit_color.setColor("seal");
        String expected = "Is the rabbit a baby?: false\n" +
